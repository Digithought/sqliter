...
| `auto_analyze_row_limit` | number | `100000` | Largest table (in known rows) an automatic statistics refresh will scan; a larger table is left to an explicit `ANALYZE`. Set to 0 to disable the cap |
